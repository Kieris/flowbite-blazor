...
### Setup
#### Import the Sidebar namespace from Flowbite.Blazor.Components.Sidebar

```razor
    @using Flowbite.Blazor.Components.Sidebar
```
      ...
      <SidebarWrapper>
        <SidebarGroup>
          ...
          <SidebarItem Label="Kanban" Class="flex-1 whitespace-nowrap">
            ...
            <Subtext>
              <span class="inline-flex justify-center items-center px-2 ml-auto text-sm font-medium text-gray-800 bg-gray-200 rounded-full dark:bg-gray-700 dark:text-gray-300"> Pro </span>
            </Subtext>
          </SidebarItem>
          <SidebarItem Label="Inbox" Class="flex-1 whitespace-nowrap">
            ...
            <Subtext>
              <span class="inline-flex justify-center items-center p-3 ml-auto w-3 h-3 text-sm font-medium text-blue-600 bg-blue-200 rounded-full dark:bg-blue-900 dark:text-blue-200">
                3
              </span>
            </Subtext>
          </SidebarItem>
...
```razor
    <Sidebar ActiveClass="flex items-center p-2 text-base font-normal text-blue-900 bg-blue-200 dark:bg-blue-700 rounded-lg dark:text-white hover:bg-blue-100 dark:hover:bg-blue-500"
             InactiveClass="flex items-center p-2 text-base font-normal text-green-900 rounded-lg dark:text-white hover:bg-green-100 dark:hover:bg-green-700">
      <SidebarWrapper>
        <SidebarGroup>
          <SidebarItem Label="Dashboard">
            <Icon>
...
#### You can change the icons using ArrowUp and ArrowDown fragments.
      ...
      <SidebarWrapper>
        <SidebarGroup>
          ...
          <SidebarDropdownWrapper Label="E-commerce">
            <Icon>
              <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
                <path d="M15 12a1 1 0 0 0 .962-.726l2-7A1 1 0 0 0 17 3H3.77L3.175.745A1 1 0 0 0 2.208 0H1a1 1 0 0 0 0 2h.438l.6 2.255v.019l2 7 .746 2.986A3 3 0 1 0 9 17a2.966 2.966 0 0 0-.184-1h2.368c-.118.32-.18.659-.184 1a3 3 0 1 0 3-3H6.78l-.5-2H15Z"/>
              </svg>
            </Icon>
            <Items>
              <SidebarDropdownItem Label="Products"></SidebarDropdownItem>
              <SidebarDropdownItem Label="Billing" Link="/docs/components/sidebar"></SidebarDropdownItem>
              <SidebarDropdownItem Label="Invoice"></SidebarDropdownItem>
            </Items>
      ...
      <SidebarWrapper>
        <SidebarGroup>
          ...
          <SidebarDropdownWrapper Label="E-commerce">
            ...
            <ArrowUp>
              <svg class="w-3 h-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 12">
    ...
    <Sidebar>
      <SidebarWrapper>
        <SidebarGroup>
          ...
          <SidebarCta Label="Beta" Class="bg-blue-50 dark:bg-blue-900">
            <Icon>
              <button type="button" class="ml-auto bg-blue-50 text-blue-900 rounded-lg focus:ring-2 focus:ring-blue-400 p-1 
              hover:bg-blue-200 inline-flex justify-center items-center h-6 w-6 dark:bg-blue-900 dark:text-blue-400 dark:hover:bg-blue-800"
...
```razor
    <Sidebar>
      <SidebarWrapper>
        <SidebarBrand Site="@(new SiteType() { ImgUrl = "https://flowbite.com/docs/images/logo.svg", Name = "Flowbite Blazor", Url = "https://flowbite.com" })"/>
        <SidebarGroup>
          <SidebarItem Label="Dashboard">
            <Icon>
              <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
...
```razor
    <div class="relative h-96 overflow-auto">
      ...
      <Sidebar class="absolute top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <SidebarWrapper>
          <SidebarGroup>
            <SidebarItem Label="Dashboard">
              <Icon>
